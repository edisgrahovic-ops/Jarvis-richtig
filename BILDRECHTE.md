# Bildrechte – Stowe Studio

Übersicht über alle verwendeten Bilder, ihre Quelle und den Rechteinhaber.
Diese Datei ist eine interne Dokumentation (kein Bestandteil der Webseite).

> **Wichtig:** Für jedes Bild muss das Nutzungsrecht tatsächlich vorliegen.
> Wenn Bilder vom Lieferanten stammen, lass dir schriftlich bestätigen, dass
> du sie für deinen Online-Shop verwenden darfst. Fremde Bilder (z. B. aus
> dem Internet) ohne Lizenz sind ein Abmahn-Risiko.
...
- **Nackenkissen:** Bilder müssen den Schultergurt und beide Farben zeigen
  (siehe todo-marker in index.html).
